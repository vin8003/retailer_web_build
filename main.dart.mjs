...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1685: (x0,x1) => x0.removeChild(x1),
      _1688: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1689: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1690: x0 => globalThis.firebase_core.getApp(x0),
      _1691: () => globalThis.firebase_core.getApp(),
      _1693: (x0,x1) => ({next: x0,error: x1}),
      _1695: x0 => globalThis.firebase_messaging.getMessaging(x0),
      _1697: (x0,x1) => globalThis.firebase_messaging.getToken(x0,x1),
      _1699: (x0,x1) => globalThis.firebase_messaging.onMessage(x0,x1),
      _1703: x0 => x0.title,
      _1704: x0 => x0.body,
      _1705: x0 => x0.image,
      ...
      _4594: x0 => x0.random(),
      _4595: (x0,x1) => x0.getRandomValues(x1),
      _4596: () => globalThis.crypto,
