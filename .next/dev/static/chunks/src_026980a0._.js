...
const Sidebar = ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
        className: "hidden md:flex flex-col w-64 bg-card border-r h-full fixed left-0 top-0",
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                ...
                children: navItems.map((item)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        href: item.href,
                        className: `flex items-center gap-3 px-4 py-3 rounded-md transition-colors ${isActive ? 'bg-primary/10 text-primary font-medium' : 'text-muted-foreground hover:bg-muted hover:text-foreground'}`,
                        children: [
...
;
const BASE_URL = ("TURBOPACK compile-time value", "http://127.0.0.1:8000/api/") || 'https://api.ordereasy.win/api/';
...
api.interceptors.response.use((response)=>response, async (error)=>{
    ...
    if (error.response?.status === 401 && !originalRequest._retry) {
        ...
        if (refreshToken) {
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${BASE_URL}auth/token/refresh/`, {
...
const authService = {
    login: (data)=>api.post('auth/retailer/login/', data),
    signup: (data)=>api.post('auth/retailer/signup/', data),
    fetchProfile: ()=>api.get('retailer/profile/'),
    registerDeviceToken: (token)=>api.post('auth/device/register/', {
    ...
    updateProfile: (data)=>{
        ...
        return api.put('retailer/profile/update/', data, {
            headers
        });
    },
...
const orderService = {
    fetchOrders: (params)=>api.get('orders/history/', {
            params
        }),
    fetchOrderDetails: (id)=>api.get(`orders/${id}/`),
    updateStatus: (id, status)=>api.patch(`orders/${id}/status/`, {
            status
        }),
    // Chat
    fetchOrderChat: (id)=>api.get(`orders/${id}/chat/`),
    sendChatMessage: (id, message)=>api.post(`orders/${id}/chat/send/`, {
            message
        }),
    markChatRead: (id)=>api.post(`orders/${id}/chat/read/`)
};
const productService = {
    fetchProducts: (params)=>api.get('products/', {
            params
        }),
    addProduct: (data)=>{
    ...
    fetchBrands: (query)=>api.get('products/brands/', {
            params: {
                search: query
            }
        }),
    fetchProductDetails: (id)=>api.get(`products/${id}/`),
    // Bulk Upload (Excel)
    checkBulkUpload: (file)=>{
    ...
    downloadTemplate: ()=>api.get('products/bulk-template/', {
            responseType: 'blob'
        }),
    // Scanner Sessions
    getActiveSessions: ()=>api.get('products/upload/session/active/'),
    getSessionDetails: (id)=>api.get(`products/upload/session/${id}/`),
    updateSessionItems: (sessionId, items)=>api.post('products/upload/session/update-items/', {
            session_id: sessionId,
            items
        }),
    commitSession: (sessionId)=>api.post('products/upload/session/commit/', {
            session_id: sessionId
        })
};
const customerService = {
    getRetailerCustomers: ()=>api.get('customer/retailer/list/'),
    getRetailerCustomerDetail: (customerId)=>api.get(`customer/retailer/details/${customerId}/`),
    toggleRetailerBlacklist: (customerId, action, reason)=>api.post('customer/retailer/blacklist/toggle/', {
            customer_id: customerId,
            action,
            reason
        }),
    rateCustomer: (orderId, rating, comment)=>api.post(`orders/${orderId}/rate-customer/`, {
            rating,
            comment
        })
};
...
const Header = ()=>{
    _s();
    const [shopName, setShopName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Retailer');
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
        className: "h-16 border-b bg-card flex items-center justify-between px-6 sticky top-0 z-10",
        children: [
...
_s(Header, "htuJTH98sFpF/8KfDvGGWc2mYhI=");
_c = Header;
...
function DashboardLayout({ children }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "grid min-h-screen w-full lg:grid-cols-[250px_1fr]",
        children: [
...
//# sourceMappingURL=src_026980a0._.js.map