...
"[project]/src/app/dashboard/rewards/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function RewardsPage() {
    ...
    const fetchConfig = async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to load reward settings");
        } finally{
            setIsLoading(false);
        }
    };
    const onSubmit = async (data)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Reward settings saved successfully");
            fetchConfig(); // Refresh
        } catch (error) {
...
_s(RewardsPage, "u3N1A2C+KJWIzm+skHPOsHLLJXQ=", false, function() {
    return [
...
//# sourceMappingURL=src_f39a67e1._.js.map